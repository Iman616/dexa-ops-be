  ...
  <div class="container">
    ...
    <div class="info-section">
      <table class="info-table">
        <tr>
          <td class="info-left">
            <span class="label">To</span>: {{ $customer->customer_name }}
          </td>
          <td class="info-right">
        ...
        <tr>
          <td class="info-left">
            <span class="label"></span>&nbsp;&nbsp;{{ $customer->address ?? '' }}
          </td>
          <td class="info-right">
        ...
        <tr>
          <td class="info-left">
            <span class="label"></span>&nbsp;&nbsp;{{ $customer->city ?? '' }}
          </td>
          <td class="info-right">
        ...
        <tr>
          <td class="info-left">
            <span class="label">Up</span>: {{ $customer->contact_person ?? '-' }}
          </td>
          <td class="info-right">
        ...
        <tr>
          <td class="info-left">
            <span class="label">Tlp/Fax</span>: {{ $customer->phone ?? '-' }}
          </td>
          <td class="info-right">
    ...
    <div class="signature-section">
      ...
      <div style="margin-top: 80px;">
        @if ($po->signed_name)
          ...
          @if ($po->signed_city && $po->signed_at)
            <div style="margin-top: 10px; font-size: 9pt; color: #666;">
              {{ $po->signed_city }}, {{ \Carbon\Carbon::parse($po->signed_at)->format('d F Y') }}
            </div>
          @endif
        @else
